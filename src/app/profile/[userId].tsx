...
export default function PublicProfileScreen() {
  ...
  return <SafeAreaView style={[styles.safe, { backgroundColor: colors.canvas }]}><View style={styles.content}>
    ...
    <View style={[styles.card, { backgroundColor: colors.surface, borderColor: colors.border }]}>
      ...
      {!!profile.photos?.length && <View style={styles.photos}>{profile.photos.map((photo) => <View key={photo.id} style={[styles.photoFrame, { borderColor: "#9B6540", shadowColor: colors.navy }]}><View style={styles.photoMat}><Image source={{ uri: photo.url }} resizeMode="cover" style={styles.photoImage} /></View></View>)}</View>}

...
function FocusedHome({ username, profilePhotoUrl, token, colors, onLogout }: { username: string; profilePhotoUrl?: string | null; token: string | null; colors: any; onLogout: () => Promise<void> }) {
  ...
  return <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.canvas }]}><ScrollView contentContainerStyle={styles.focusedContent}>
    ...
    <View style={styles.gameSection}><Text style={[styles.gameSectionTitle, { color: colors.text }]}>Quick games</Text><Text style={[styles.gameSectionCopy, { color: colors.muted }]}>Take a short break without leaving your desk.</Text><View style={styles.gameRow}><TouchableOpacity onPress={() => router.push("/tic-tac-toe" as any)} style={[styles.gameTile, { backgroundColor: colors.tealSoft, borderColor: colors.teal }]}><Text style={[styles.gameTileIcon, { color: colors.teal }]}>⊞</Text><Text style={[styles.gameTileTitle, { color: colors.text }]}>Tic-Tac-Toe</Text><Text style={[styles.gameTileText, { color: colors.muted }]}>Anonymous two-player match</Text></TouchableOpacity><TouchableOpacity onPress={() => router.push("/connect-four" as any)} style={[styles.gameTile, { backgroundColor: colors.violetSoft, borderColor: colors.violet }]}><Text style={[styles.gameTileIcon, { color: colors.danger }]}>●</Text><Text style={[styles.gameTileTitle, { color: colors.text }]}>Connect Four</Text><Text style={[styles.gameTileText, { color: colors.muted }]}>Line up four discs to win</Text></TouchableOpacity><TouchableOpacity onPress={() => router.push("/tetris" as any)} style={[styles.gameTile, { backgroundColor: colors.amberSoft, borderColor: colors.amber }]}><Text style={[styles.gameTileIcon, { color: colors.amber }]}>▦</Text><Text style={[styles.gameTileTitle, { color: colors.text }]}>Tetris</Text><Text style={[styles.gameTileText, { color: colors.muted }]}>Solo score break</Text></TouchableOpacity><TouchableOpacity onPress={() => router.push("/mini-sudoku" as any)} style={[styles.gameTile, { backgroundColor: colors.greenSoft, borderColor: colors.green }]}><Text style={[styles.gameTileIcon, { color: colors.green }]}>1·2</Text><Text style={[styles.gameTileTitle, { color: colors.text }]}>{t("miniSudoku")}</Text><Text style={[styles.gameTileText, { color: colors.muted }]}>{t("sudokuSubtitle")}</Text></TouchableOpacity></View></View>
    <DeskNotesTicker />

...
const styles = StyleSheet.create({
  ...
  focusedContent: { padding: 22, paddingTop: 32, paddingBottom: 36 }, focusedHeader: { flexDirection: "row", justifyContent: "space-between", gap: 14 }, focusedTitle: { fontSize: 27, fontWeight: "900" }, focusedSub: { fontSize: 14, lineHeight: 20, marginTop: 6, maxWidth: 270 }, deskScene: { borderRadius: 24, marginTop: 28, padding: 20, minHeight: 280, overflow: "hidden" }, window: { color: "#FFE7C4", fontSize: 24, textAlign: "right" }, deskPlane: { color: "#FFF7E8", fontSize: 38, transform: [{ rotate: "-15deg" }], marginTop: 20, marginLeft: 42 }, deskTop: { height: 80, borderRadius: 10, marginTop: 40, opacity: .9 }, deskCaption: { color: "#F5D9BB", fontSize: 13, marginTop: 13 }, sendPlaneButton: { padding: 14, borderRadius: 12, marginTop: 16, alignItems: "center" }, sendPlaneText: { fontWeight: "900" }, focusedGrid: { flexDirection: "row", gap: 12, marginTop: 14 }, focusedTile: { flex: 1, minHeight: 145, borderWidth: 1, borderRadius: 18, padding: 16 }, tileIcon: { fontSize: 21, fontWeight: "900" }, tileTitle: { fontSize: 16, fontWeight: "900", marginTop: 16 }, tileText: { fontSize: 12, lineHeight: 18, marginTop: 5 }, accountLink: { alignSelf: "center", padding: 18, marginTop: 14 }, accountLinkText: { fontWeight: "800", fontSize: 13 },

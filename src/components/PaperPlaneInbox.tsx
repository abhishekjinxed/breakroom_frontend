  ...
  return <>
    ...
    <Modal transparent visible={!!selected} animationType="fade" onRequestClose={() => setSelected(null)}>
      <View style={styles.backdrop}><View style={styles.letter}>
        ...
        {selected && <View style={styles.senderIdentity}><PublicAvatar member={selected.sender} size={30} /><View><Text style={styles.fromLabel}>{t("from")}</Text><PublicFlair member={selected.sender} nameColor="#3E281E" flairColor="#806657" /></View></View>}

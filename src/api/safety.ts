...
export async function reportContent(token: string, targetType: "PULSE" | "NOTE" | "MESSAGE" | "USER" | "STICKY_NOTE" | "STICKY_COMMENT", targetId: string, reason: string) { return api.post("/api/safety/reports", { targetType, targetId, reason }, auth(token)); }
